...
namespace WebAPI.Model
{
    public class Contrato: Entity<int>
    {
        ...
        public string periodoDesde { get => PeriodoDesde.ToString("dd-MM-yyyy"); }
        public string periodoHasta { get => PeriodoHasta.ToString("dd-MM-yyyy"); }
        public string maxFechaVig  { get => MaxFechaVig.ToString("dd-MM-yyyy"); }
